...
!! Esse resultado faz um contraponto ao trabalho feito por
\citeonline{Arpornwichanop2002}. Neste trabalho, foi simulado um
reator de hidrogenação de gasolina de pirólise onde, no balanço de energia, a
inércia térmica dos leitos catalíticos nas respostas dinâmicas foi desprezada.
\citeonline{Arpornwichanop2002} não publicaram dados de planta para verificar se
a modelagem por eles proposta representa o reator modelado.

Recentemente, \citeonline{Elizalde2016} apresentam a modelagem dinâmica de um
reator de hidrocraquemento catalítico. Este trabalho também deixou de considerar a
presença do catalisador no balanço de energia.
