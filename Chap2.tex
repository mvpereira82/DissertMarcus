...
Segundo \citeonline{Froment2011}, os modelos são categorizados em dois grandes
grupos: pseudo-homogêneos e heterogêneos. Os modelos pseudo-homogêneos não fazem
...
modelos heterogêneos distinguem, no mínimo, as partículas de catalisador como
sendo uma fase distinta.
...
e/ou calor. Já os unidimensionais consideram escoamento empistonado, com ou sem
dispersão axial.
...
predição são divididos em estocásticos e determinísticos. Os modelos
...
Dentro dos modelos determinísticos surgem outros dois grupos: modelos contínuos
e modelos discretos. Os modelos contínuos contém um conjunto de equações
diferenciais com uma ou mais variáveis independentes. Já os modelos discretos
são representados por um número finito de elementos de reator para descrever o
processo como um todo \cite{Ancheyta2011}.

\citeonline{Deans1960} construiram um modelo baseado em estágios discretos,
chamado de rede de células de mistura por alguns
autores (\citeonline{Schnitzlein1987} e \citeonline{Ancheyta2011}, por exemplo).
O método de modelagem por células, neste caso, foi aplicado para estudar os
fenômenos de dispersão axial e radial. Independente do arranjo das células, a
descrição do sistema reacional dentro de cada célula pode ser pseudo-homogêneo
ou heterogêneo \cite{Schnitzlein1987}.

Outra abordagem discreta são os modelos baseados em estágios. Nesses modelos há
...
\section {Modelagem de Reatores de Hidrogenação de Gasolina de Pirólise}
