...
A definição do tipo de escoamento é muito importante, pois vários parâmetros hidrodinâmicos e de transporte são influenciados pelo regime de escoamento. Esses parâmetros podem influenciar tanto no dimensionamento dos reatores quanto nos equipamentos dinâmicos (bombas, compressores) \cite{Ranade2011}.

Segundo \apudonline{Chaudhari1983}{Ranade2011}, 4 regimes de escoamento foram identificados em TBRs: 
