...
flash foi feito, aperfeiçoando os balanços de massa e energia comumente
empregados em reatores de leito gotejante. !! A abordagem termodinâmica
utilizada para prever o ELV foi a $\phi_i$ - $\phi_i$, com a EoS de SRK
...
pirólise. !! O modelo foi implementado no software \emso{} (\emsoname{}) cerca
de 9000 equações e variáveis. Os resultados foram comparados com disponíveis na
literatura. !! A aplicação de modelagem por células mostrou-se não só aplicável
mas também mais robusta do que abordagens tradicionais quen utilizam EDOs. Os
resultados obtidos foram similares ao encontrados por \citeonline{Rojas2014a}. A
utilização da ferramenta \emso{} para a modelagem por células mostrou-se ainda
mais vantajosa ao permitir a avaliação do comportamento dinâmico do reator em
algumas situações hipotética, mas que são bem comuns na industria. !! }
