...
$r_{j,z}$ é taxa da reação $j$ na célula $z$, $F$ é a vazão molar total e $W$ é a massa total de
...
?? Faltou aqui a relação entre $E_z$ e a energia da massa que se encontra na
célula. Esta equação que vai mostrar se a inércia térmica do catalisador
está ou não sendo considerada no modelo ??
...
listados na \autoref{tab:composicao}. Conforme já explicado, o sistema reacional foi
