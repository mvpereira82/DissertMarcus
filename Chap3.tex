...
adotou-se a massa específica do \ce{Al2O3} puro ($\rho_{\ce{Al2O3}}$ = \SI{3940}
...
Ao passo que as variáveis avaliadas internamente em cada célula (?? colocar aqui
alguns exemplos de variáveis, talvez até adicionar na própria figura algumas
delas??) possuem dimensão $N_{Disc}$.
...
?? tirar o 'enter' antes das equações e antes dos 'sendo/onde', como feito acima ??
...
?? colocar aqui ou em algum outro lugar exatamente o deltaij utilizado.
Pode pegar nas referencias originais ou na eq. 2.21 do documento
http://www.lume.ufrgs.br/bitstream/handle/10183/143899/000998153.pdf?sequence=1
(não citar o TCC, mas sim a fonte original)
??
...
?? Veja se gostou desta formatação com 'code' para aplicar no resto, você escolhe ??
